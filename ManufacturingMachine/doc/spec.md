...
- `address`: The mailing address  - `alternateName`: An alternative name for this item  - `areaServed`: The geographic area where a service or offered item is provided  - `assetIdentifier`: An asset identifier (e.g. asset tag number) assigned by the owner.  - `batteryLevel`: Battery level. It must be equal to: 1.0 When the battery charge is full. 0.0 When the battery charge empty. Null when it cannot be determined.  - `building`: Reference to the building entity instance into which this machine is installed  - `countryOfManufacture`: The country where this machine was manufactured.  - `current`: The nominal required supply current (at the nominal supply voltage), in amps  - `dataProvider`: A sequence of characters identifying the provider of the harmonised data entity.  - `dateCreated`: Entity creation timestamp. This will usually be allocated by the storage platform.  - `dateModified`: Timestamp of the last modification of the entity. This will usually be allocated by the storage platform.  - `description`: A description of this item  - `factory`: The factory name/code manufacturing this machine.  - `firmwareVersion`: The (manufacturer specific) firmware version of this machine.  - `firstUsedAt`: Indicates the date/time at which date and time the machine was first used (nominally in UTC).  - `hardwareVersion`: The (manufacturer specific) hardware version of this machine.  - `id`: Unique identifier of the entity  - `installationNotes`: Notes relating to this machine installation.  - `installedAt`: Indicates the date/time at which date and time the machine was installed (nominally in UTC).  - `location`: Geojson reference to the item. It can be Point, LineString, Polygon, MultiPoint, MultiLineString or MultiPolygon  - `machineModel`: A reference to the associated Machine Model for this machine.  - `machineOwner`: Reference to the owner or owners of the machine as either a Schema.org person or organization.  - `manufacturedAt`: Indicates the date/time at which date and time the machine was manufactured (nominally in UTC).  - `name`: The name of this item.  - `online`: The communication status of this machine. A logical representation of Offline (false) or Online (true).  - `osVersion`: The (manufacturer specific) operating system version of this machine  - `owner`: A List containing a JSON encoded sequence of characters referencing the unique Ids of the owner(s)  - `power`: The nominal rated power consumption of the machine in kW  - `rotationalSpeed`:  	The maximum rotational speed in rpm (for machines such as drills, lathes)  - `seeAlso`: list of uri pointing to additional resources about the item  - `serialNumber`: The serial number assigned by the manufacturer.  - `softwareVersion`: The (manufacturer specific) software version of this machine.  - `source`: A sequence of characters giving the original source of the entity data as a URL. Recommended to be the fully qualified domain name of the source provider, or the URL to the source object.  - `status`: Text formatted (current) machine status code or description. Expected to be the manufacturer or machine specific status code generated by the machine.  - `subscriptionService`: Reference to service subscriptions related to this machine e.g. energy supplies, Internet Service Providers etc, maintenance  - `supplierName`: The name of the supplier of this machine.  - `supportedProtocol`: Supported protocol(s) or networks.  - `type`: NGSI entity type. It has to be Machine.  - `voltage`: The nominal required supply voltage, in volts    
